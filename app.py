...
def create_app(db_url=None):
    ...
    app.config["MYSQL_HOST"] = db_url or os.environ.get("mysql_host")
    app.config['MYSQL_USER'] = os.environ.get("mysql_user")
    app.config['MYSQL_PASSWORD'] = os.environ.get("mysql_pwrd")
    app.config['MYSQL_DB'] = os.environ.get("mysql_db_name")
