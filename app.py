...
def create_app(db_url=None):
    ...
    app.config["MYSQL_HOST"] = "83.229.67.41" or os.environ.get("mysql_host")
    app.config['MYSQL_USER'] = "root" or os.environ.get("mysql_user")
    app.config['MYSQL_PASSWORD'] = "M@nkeyBus!ne$$96!" or os.environ.get("mysql_pwrd")
    app.config['MYSQL_DB'] = "MovieRanker" or os.environ.get("mysql_db_name")
